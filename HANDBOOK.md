...
- The gate also refuses:
  ...
  - Roslyn's generated markers on any file the repository's own generator does not produce: a file name Roslyn
    reads as generated, a leading `<auto-generated` or `<autogenerated` comment, and `[GeneratedCode`. A generated
    file loses its analyzers and its nullable checks. The gate regenerates a produced one and diffs it
    (Authoring), so a hand edit under the marker fails;
